...
<body>
    <div class="container">
        <div class="image-section">
            <img src="https://www.shutterstock.com/image-photo/handsome-taxi-driver-car-on-600nw-2056944956.jpg" alt="Driver Login">
        </div>
        <div class="form-section">
            ...
            <h2>Driver Login</h2>
            <p>Check your email and get your password here...</p>
...
<% } %>
            ...
            <div class="signup-link">
                Don't have an account? <a href="<%= request.getContextPath() %>/Driver/driverRegister.jsp">Sign Up</a>
