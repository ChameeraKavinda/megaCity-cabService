...
<%
    ...
    List<Customer> customerList = customerDOA.getAllCustomers();
%>
    ...
    <div class="main-content">
        <div class="header">
            ...
            <div class="header-search">
                ...
                <input type="text" placeholder="Search customer members...">
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button class="action-button">
                            <a href="<%= request.getContextPath() %>/View/customerRegister.jsp"><i class="ri-user-add-line"></i> <span>Add New Customer</span></a>
            ...
            <tr>
               ...
               <td class="action-cell">
                    ...
                    <form action="DeleteCustomer" method="POST" style="display:inline;">
                        <input type="hidden" name="customerId" value="<%= customer.getCustomerId() %>">
                       <button type="submit" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this customer?');">Delete</button>
                    </form>
                </td>
            </tr>
        <% } %>
                        ...
                        <% for (Customer customer : customerList) { %>
                            <div class="mobile-card">
                                <div class="mobile-card-header">
                                    <div class="mobile-card-title"><%= customer.getName() %></div>
                                   
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">ID:</div>
                                    <div class="mobile-card-value"><%= customer.getCustomerId() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Email:</div>
                                    <div class="mobile-card-value"><%= customer.getEmail() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Password:</div>
                                    <div class="mobile-card-value"><%= customer.getPassword() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Nic Numbeer:</div>
                                    <div class="mobile-card-value"><%= customer.getNicNumber() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Phone:</div>
                                    <div class="mobile-card-value"><%= customer.getPhoneNumber() %></div>
                                </div>
                                <div class="mobile-card-row">
