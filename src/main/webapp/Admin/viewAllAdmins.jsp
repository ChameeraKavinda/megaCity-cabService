...
<%
    ...
    List<Admin> adminList = adminDOA.getAllAdmins();
%>
...
<head>
    ...
    <title>Mega City Cab Service - Admin Management</title>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul>
           ...
           <%
			...
			%>
    		<li>
        		<a href="<%= request.getContextPath() %>/Admin/updateAdmin.jsp?adminId=<%= loggedInAdmin.getAdminId() %>">
    ...
    <div class="main-content">
        <div class="header">
            <div class="header-left">
                ...
                <div class="header-title">Admin/Staff Management</div>
            </div>
        ...
        <div class="content-wrapper">
            <div class="card">
                <div class="card-header">
                    <h3>Admin/Staff Details</h3>
                    <button class="action-button">
                            <a href="<%= request.getContextPath() %>/Admin/adminRegister.jsp"><i class="ri-user-add-line"></i> <span>Add New Member</span></a>
                            ...
                            <tbody>
                                <% for (Admin admin : adminList) { %>
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge <%= admin.getRole().equals("Admin") ? "badge-success" : "badge-warning" %>">
                                                <%= admin.getRole() %>
                                            </span>
                                        </td>
                                        <td class="action-cell">
                                            <form action="<%= request.getContextPath() %>/Admin/updateAdmin.jsp" method="GET" style="display:inline;">
                        ...
                        <% for (Admin admin : adminList) { %>
                            <div class="mobile-card">
                                <div class="mobile-card-header">
                                    <div class="mobile-card-title"><%= admin.getName() %></div>
                                    <span class="badge <%= admin.getRole().equals("Admin") ? "badge-success" : "badge-warning" %>">
                                        <%= admin.getRole() %>
                                    </span>
                                </div>
                                <div class="mobile-card-row">
                                    ...
                                    <div class="mobile-card-value"><%= admin.getAdminId() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Email:</div>
                                    <div class="mobile-card-value"><%= admin.getEmail() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Password:</div>
                                    <div class="mobile-card-value"><%= admin.getPassword() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Phone:</div>
                                    <div class="mobile-card-value"><%= admin.getPhoneNumber() %></div>
                                </div>
                                <div class="mobile-card-actions">
                                    <form action="<%= request.getContextPath() %>/Admin/updateAdmin.jsp" method="GET">
                                        <input type="hidden" name="adminId" value="<%= admin.getAdminId() %>">
                                        <button type="submit" class="action-btn update-btn">Update</button>
                                    </form>
