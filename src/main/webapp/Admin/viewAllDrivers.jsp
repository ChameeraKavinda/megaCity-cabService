...
DriverDOA driverDOA = new DriverDOA();
    List<Driver> driverList = driverDOA.getAllDriverss();
%>
...
<head>
    ...
    <title>Mega City Cab Service - Driver Management</title>
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <ul>
            ...
            <li>
                <a href="#">
                    <i class="ri-steering-2-line" class="active"></i>
                    Driver Management
                </a>
            </li>
            <li>
    ...
    <div class="main-content">
        <div class="header">
            ...
            <div class="header-search">
                ...
                <input type="text" placeholder="Search driver members...">
            </div>
        </div>
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <button class="action-button">
                            <a href="<%= request.getContextPath() %>/Driver/driverRegister.jsp"><i class="ri-user-add-line"></i> <span>Add New Driver</span></a>
            ...
            <tr>
                ...
                <td>
                 ...
                 <td class="action-cell">
                    <form action="<%= request.getContextPath() %>/Admin/updateDriver.jsp" method="GET" style="display:inline;">
                    ...
                    <form action="DeleteDriver" method="POST" style="display:inline;">
                        <input type="hidden" name="driverId" value="<%= driver.getDriverId() %>">
                       <button type="submit" class="action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this driver?');">Delete</button>
                    </form>
                </td>
            </tr>
        <% } %>
                        ...
                        <% for (Driver driver : driverList) { %>
                            <div class="mobile-card">
                                ...
                                <div class="mobile-card-row">
                                    ...
                                    <div class="mobile-card-value"><%= driver.getDriverId() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Email:</div>
                                    <div class="mobile-card-value"><%= driver.getEmail() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Password:</div>
                                    <div class="mobile-card-value"><%= driver.getPassword() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Nic Numbeer:</div>
                                    <div class="mobile-card-value"><%= driver.getNic() %></div>
                                </div>
                                <div class="mobile-card-row">
                                    <div class="mobile-card-label">Phone:</div>
                                    <div class="mobile-card-value"><%= driver.getPhoneNumber() %></div>
                                </div>
