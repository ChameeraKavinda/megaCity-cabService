...
/**
 * Servlet implementation class AdminBookingConroller
 */
@WebServlet("/Admin/adminAddBooking")
public class AdminBookingConroller extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private BookingService bookingService;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public AdminBookingConroller() {
        super();
